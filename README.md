...
- [게임 플레이 루프](#게임-플레이-루프)
- [주요 시스템](#주요-시스템)
  - [1. 서비스 로케이터 기반 GameManager](#1-서비스-로케이터-기반-gamemanager)
  - [2. 스테이지 구성 (데이터 주도)](#2-스테이지-구성-데이터-주도)
  - [3. 에셋 로딩 / 오브젝트 풀링](#3-에셋-로딩--오브젝트-풀링)
  - [4. 일꾼 AI — Behaviour Tree](#4-일꾼-ai--behaviour-tree)
  - [5. UI — MVVM](#5-ui--mvvm)
- [프로젝트 구조](#프로젝트-구조)
- [팀](#팀)
